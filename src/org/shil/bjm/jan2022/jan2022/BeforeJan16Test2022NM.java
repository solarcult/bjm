...
public class BeforeJan16Test2022NM extends PlayerStrategyMatrix {
    public static PlayerStrategyMatrix SELF = new BeforeJan16Test2022NM();

    public BeforeJan16Test2022NM() {
        super();
...
//        compare();
        ...
        PlayerCardsPathValue oc = new PlayerCardsPathValue(Card.Three3,Card.Seven7);
        Card dealerCard = Card.Nine9;

        System.out.println("\n                  --- " + oc.getValue() +" vs "+ dealerCard + " ---");
        System.out.println();
        ...
        Strategy beforeOneStrategy =  new OneStrategy(BeforeJan16Test2022NM.SELF,null,null);
...
//		Collection<PlayerCardsPathValue> playerCards = PlayerCards.sortedOneValueStartCardsWithA();
        ...
        OneStrategy beforeOneStrategy = new OneStrategy(BeforeJan16Test2022NM.SELF,null,null);
        ...
        Jan16Test2022NM jan16Test2022NM = new Jan16Test2022NM();
        BeforeJan16Test2022NM beforeJan16Test2022NM = new BeforeJan16Test2022NM();
