...
public class MirrorJan18PairCard2022Matrix extends PlayerStrategyMatrix {
	...
	public MirrorJan18PairCard2022Matrix(){
		...
		PlayerStrategy playerStrategy22vs6 = new PlayerStrategy(StartValue.getOne(2), Card.Six6, PlayerAction.Hit,PlayerAction.Hit);
		...
		PlayerStrategy playerStrategy33vs6 = new PlayerStrategy(StartValue.getOne(3), Card.Six6, PlayerAction.Hit,PlayerAction.Hit);
