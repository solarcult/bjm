...
public class WdlRateWithDSWithProbRateComparator implements Comparator<StrategyMatrix8012> {
	...
	public int compare(StrategyMatrix8012 arg0, StrategyMatrix8012 arg1) {
		if(arg0.getWdlRateWithDSWithProbRate()[0] > arg1.getWdlRateWithDSWithProbRate()[0]) {
			return -1;
		}else if(arg0.getWdlRateWithDSWithProbRate()[0] < arg1.getWdlRateWithDSWithProbRate()[0]) {
			return 1;
		}
		return 0;
	}
